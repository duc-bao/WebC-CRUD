...
namespace WebC_CRUD.Migrations
{
    ...
    [Migration("20240709122805_Seeding Data for Difficult and Region")]
    partial class SeedingDataforDifficultandRegion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebC_CRUD.Model.Domain.Difficulty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebC_CRUD.Model.Entity.Region", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebC_CRUD.Model.Entity.Walk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebC_CRUD.Model.Entity.Walk", b =>
                {
                    b.HasOne("WebC_CRUD.Model.Domain.Difficulty", "Difficulty")
                        .WithMany()
                        .HasForeignKey("DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebC_CRUD.Model.Entity.Region", "Region")
                        .WithMany()
